...
func NewMQTTAdapter(db domain.ITemperatureAndHumidity, serviceNotification *repositories.ServiceNotification) (*MQTTAdapter, error) {
	useCase := use_case.NewCreate_TemperatureAndHumidity(db, serviceNotification)
